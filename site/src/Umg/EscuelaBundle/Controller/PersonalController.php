...
use Umg\EscuelaBundle\Entity\Personal;
use Umg\EscuelaBundle\Form\PersonalType;
...
class PersonalController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('UmgEscuelaBundle:Personal')->findAll();
     ...
     * @Method("POST")
     * @Template("UmgEscuelaBundle:Personal:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('UmgEscuelaBundle:Personal')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("UmgEscuelaBundle:Personal:edit.html.twig")
     */
