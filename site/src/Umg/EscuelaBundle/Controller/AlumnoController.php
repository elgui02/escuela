...
use Umg\EscuelaBundle\Entity\Alumno;
use Umg\EscuelaBundle\Form\AlumnoType;
...
class AlumnoController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('UmgEscuelaBundle:Alumno')->findAll();
     ...
     * @Method("POST")
     * @Template("UmgEscuelaBundle:Alumno:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('UmgEscuelaBundle:Alumno')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("UmgEscuelaBundle:Alumno:edit.html.twig")
     */
